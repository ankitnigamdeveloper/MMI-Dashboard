  ...
  return (
    <Row>
      <Col>
        ...
        {/* --------------------------------------------------------------------------------*/}
        <ComponentCard
          title="MMI React Admin Dashboard"
          subtitle={
            <p>
               highly customizable demo variations included in the package, with React
              Router 6, Redux Toolkit, Axios and much more...
            </p>
          }
        >
          ...
          <Row>
            <Col lg="8">
              <div className="mt-3">
                <Button
                  color="primary"
                  href="http://www.mindminesinfotech.com/"
                  target="_blank"
                >
                  Detail
                </Button>
